  ...
  return (
    <div style={{minHeight:"100vh",background:T.bg,fontFamily:FONT,color:T.text}}>
      ...
      <nav style={{background:"#fff",borderBottom:`1px solid ${T.border}`,padding:"0 16px",display:"flex",alignItems:"center",gap:6,minHeight:60,position:"sticky",top:0,zIndex:100,flexWrap:"wrap"}}>
        ...
        {/* Mobile hamburger */}
        <button className="mobile-only" onClick={()=>setMobileMenuOpen(!mobileMenuOpen)} style={{display:"none",background:T.primary,color:"#fff",border:"none",borderRadius:10,padding:"8px 12px",fontSize:18,cursor:"pointer"}}>
          {mobileMenuOpen?"✕":"☰"}
        </button>

        {/* Mobile menu */}
        {mobileMenuOpen&&(
          <div className="mobile-only" style={{display:"none",width:"100%",padding:"8px 0",borderTop:`1px solid ${T.border}`,flexDirection:"column",gap:4}}>
            {TABS.map(t=>(
